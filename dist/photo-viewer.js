...
$(document).on("click", ".thumb", function (e) { // When a thumb is clicked on
  ...
  $thumbs.removeClass("thumb-active"); // Remove active from all thumbs
  $(this).addClass("thumb-active"); // Add active to clicked thumb
...
$(".thumb").eq(0).click(); // Stimulate click on first thumbnail
